 ...
 * It will be sort of like the Spotify-recommended songs. The language we will code in is C++. We will also be using Web API which is metadata from Spotify content.
 > * What will be the input/output of your project?
 > * The input will be the user's personal info (first and last name, date of birth, username, and password), name of the song or album they would like to rate, a number between 0.0 and 10.0 to rate, and a written review is also optional. The output will be a diary of all the songs and albums that the user has rated and reviewed, a graph showing their ratings 0.0-10.0 for all songs or albums, and a list of song/album recommendations based on their ratings.
